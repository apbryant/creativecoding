...
void main(){
  ...
  color = vec3(pct);
  color += circle(st, 0.5, vec2(0.75,0.75), 0.9);
  color *= 1. - circle(st, 0.5, vec2(0.25,0.25), 0.9);
  color *= 1. - circle(st, 0.06, vec2(0.75,0.75), 0.05);
  color += circle(st, 0.06, vec2(0.25,0.25), 0.05);
